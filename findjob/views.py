...
def all_vacancies(request):
    vacancies_list = Vacancy.objects.values('id', 'title', 'skills', 'description', 'salary_min', 'salary_max',
                                            'specialty', 'company')
...
def all_vacancies_special(request, specialty_input: str):
    ...
    vacancies_list = specialties_list.vacancies.values('id', 'title', 'skills', 'description', 'salary_min',
                                                       'salary_max', 'specialty', 'company')
...
def vacancy_cart(request, vacancy_id: int):
    vacancies_queryset = Vacancy.objects.values('id', 'title', 'skills', 'description', 'salary_min', 'salary_max',
                                                'specialty', 'company')
    vacancies_list = get_object_or_404(vacancies_queryset, id=vacancy_id)
